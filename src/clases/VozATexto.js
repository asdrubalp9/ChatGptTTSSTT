    ...
    addListeningScreen() {
        ...
        <style>
            ...
            <div style="display:flex; justify-content:center; flex-direction:column; gap:10px;">
                <div class="" id="listeningState" class="pulse" data-state="playing">
                </div>
                <p id="transcript"></p>
                <div class="row" style="display:flex; flex-direction:row; justify-content:between; gap:20px;">
                    <div class="d-fd-column">
                        <button class="btn btn-primary" id="aproveText">
                        ...
                        <span class="text-small text-muted">${chrome.i18n.getMessage("PressAToApprove")}</span>
                        
                    </div>
                    <div class="d-fd-column">
                        <button class="btn btn-dark" id="restart">
                        ...
                        <span class="text-small text-muted">${chrome.i18n.getMessage("PressRToRestart")}</span>
                    </div>
                    <div class="d-fd-column">
                        <button class="btn btn-danger" id="cancelListening">
                        ...
                        <span class="text-small text-muted">${chrome.i18n.getMessage("PressEscToCancel")}</span>
                    </div>
                </div>
            </div>
        `;
