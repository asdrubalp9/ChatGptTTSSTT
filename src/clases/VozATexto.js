            ...
            <div style="display:flex; justify-content:center; flex-direction:column; gap:10px;">
                ...
                <div class="row" style="display:flex; flex-direction:row; justify-content:between; gap:20px;">
                    <div class="d-fd-column">
                        ...
                        <span class="text-small text-muted">Approve text pressing A</span>
                    ...
                    <div class="d-fd-column">
                        ...
                        <span class="text-small text-muted">Restart pressing R</span>
                    </div>
                    <div class="d-fd-column">
                        ...
                        <span class="text-small text-muted">Cancel pressing ESC</span>
                    </div>
                </div>
            </div>
        `;
